            ...
            <div class="panel panel-primary panel-hovered panel-stacked mb30">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-block col-md-4"><a
                                href="https://github.com/MimoAssistBilling/wiki/Themes" target="_blank">Theme
                                info</a></p>
                    </div>
                    <div class="form-group">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <p class="help-block col-md-4"><a
                                href="https://github.com/MimoAssistBilling/wiki/FreeRadius"
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-offset-2 col-md-8" style="text-align: left;">Envato
                            ...
                            <a href="https://codecanyon.net/category/php-scripts?term=MimoAssist" target="_blank"
