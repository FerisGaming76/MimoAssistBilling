                    ...
                    <div class="box box-danger box-solid">
                        ...
                        <div class="box-body" style="font-size: larger;">
                            ...
                            <ul>
                                ...
                                <li>Make sure your Mikrotik accessible from MimoAssist</li>
                            </ul>
                            If you just update MimoAssist from upload files, try click Update Database
                        </div>
                        <div class="box-footer">
                            ...
                            class="btn btn-success btn-sm btn-block" style="color: black;">Ask Github Community</a>
                                <a href="https://t.me/MimoAssist" target="_blank"
