 ...
 *
 * This script is for updating MimoAssist
 **/
session_start();
include "config.php";

if (empty($update_url)) {
    $update_url = 'https://github.com/MimoAssistBilling/archive/refs/heads/master.zip';
}
...
$file = pathFixer('system/cache/MimoAssist.zip');
$folder = pathFixer('system/cache/MimoAssist-' . basename($update_url, ".zip") . '/');
...
<head>
    ...
    <title>MimoAssist Updater</title>
...
<body class="hold-transition skin-blue">
    <div class="container">
                    ...
                    <?php if ($continue || $step == 5) { ?>
                        ...
                        <?php } else if ($step == 5) { ?>
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body">
                                    MimoAssist has been updated to Version <b><?= $version ?></b>
                                </div>
                            </div>
        ...
        <footer class="footer text-center">
            MimoAssist by <a href="https://github.com/MimoAssistBilling" rel="nofollow noreferrer noopener" target="_blank">mimoassist</a>
        </footer>
    </div>
</body>
