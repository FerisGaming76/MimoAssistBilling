...
class Mpdf implements \Psr\Log\LoggerAwareInterface
{
	...
	function _getBorderWidths($bindata)
	{
		...
		$bd = unpack("nbord/nrs/drw/a6rca/A10rst/nrd/nls/dlw/a6lca/A10lst/nld/nts/dtw/a6tca/A10tst/ntd/nbs/dbw/a6BRI/A10bst/nbd/dmbl/dmbr/dmrt/dmrb/dmtl/dmtr/dmlt/dmlb/dcpd", $bindata);
	...
	function _unpackCellBorder($bindata)
	{
		...
		$cell['border_details']['B']['w'] = $bd['bw'];
		$cell['border_details']['B']['c'] = str_pad($bd['BRI'], 6, "\x00");
